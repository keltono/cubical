...
module Cubical.Delooping.Cayley where
...
open import Cubical.Delooping.Generators
open import Cubical.Delooping.Coeq
...
module _ {G : Group ℓ} {X : hSet ℓ} (γ : ⟨ X ⟩ → ⟨ G ⟩) (gen : generates {X = X} {G = G} γ) where
  ...
  Cayley-ker =
    ...
    equiv = Cubical.Delooping.Coeq.elim f g
